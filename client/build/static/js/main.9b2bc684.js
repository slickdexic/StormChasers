...
`,Cd=Ui.g`
  ...
  ${e=>e.isRacing&&Mi`
    animation: ${kd} 1s ease-in-out infinite;
  `}
`,jd=Ui.circle`
  stroke-width: 0.2;
  stroke: #fff;
...
`,zd=e=>{let{players:t,trackPositions:n,placedCoins:i,activePlayerId:o,stage:a,onLaneSelect:s,onCoinPlacement:l,focusOnPolePosition:u=!1,showControls:c=!0,showInfo:d=!0,showPositionNumbers:f=!1}=e;const[p,h]=(0,r.useState)(0),[g,m]=(0,r.useState)(0),[v,y]=(0,r.useState)(1),[b,x]=(0,r.useState)(!1),[w,_]=(0,r.useState)({x:0,y:0}),[k,S]=(0,r.useState)(!1),E=(0,r.useRef)(),{lanes:C,pitLane:j,pitStops:T,loading:R,error:O}=bd(),P={red:"#e74c3c",blue:"#3498db",green:"#2ecc71",yellow:"#f1c40f",purple:"#9b59b6",orange:"#e67e22",black:"#2c3e50"},N=(0,r.useCallback)((e,t)=>{if(R||O)return{x:0,y:0};const n=(C[t]||[]).find(t=>t.id===String(e));return n?{x:n.x,y:n.y}:{x:0,y:0}},[C,R,O]),z=(0,r.useCallback)(e=>{if(R||O)return{x:0,y:0};const t=T.find(t=>t.id===e);return t?{x:t.x,y:t.y}:{x:0,y:0}},[T,R,O]);(0,r.useEffect)(()=>{if("lane-selection"===a&&u&&!R){const e=N(96,1);if(0===e.x&&0===e.y)return;const t=E.current.offsetWidth,n=E.current.offsetHeight;S(!0),y(2.5),h(2.5*-e.x+t/2),m(2.5*-e.y+n/2),setTimeout(()=>S(!1),1e3)}},[u,a,N,R]);const A=()=>{x(!1)},L=e=>{"lane-selection"===a&&s&&"96"===e.id&&s(e.lane),"coin-placement"===a&&l&&l({position:e.id,lane:e.lane})},$="lane-selection"!==a;return(0,qt.jsxs)(Sd,{ref:E,panEnabled:$,onMouseDown:e=>{$&&(x(!0),_({x:e.clientX,y:e.clientY}))},onMouseMove:e=>{if(!b||!$)return;const t=e.clientX-w.x,n=e.clientY-w.y;h(e=>e+t),m(e=>e+n),_({x:e.clientX,y:e.clientY})},onMouseUp:A,onMouseLeave:A,onWheel:e=>{if(!$)return;e.preventDefault();const t=Math.max(.5,Math.min(v-.001*e.deltaY,5)),n=E.current.getBoundingClientRect(),r=e.clientX-n.left,i=e.clientY-n.top,o=(i-g)/v;h(r-(r-p)/v*t),m(i-o*t),y(t)},children:[(0,qt.jsx)(Ed,{panX:p,panY:g,zoom:v,animating:k,children:(0,qt.jsxs)("svg",{viewBox:"-20 -20 40 40",style:{width:"100%",height:"100%",overflow:"visible"},children:[(0,qt.jsx)(_d,{showNumbers:f}),!R&&"lane-selection"===a&&Object.values(C).map(e=>{const t=e.find(e=>"96"===e.id);if(!t)return null;const r=n&&!Object.values(n).some(e=>e.lane===t.lane);return(0,qt.jsx)("circle",{cx:t.x,cy:t.y,r:"0.8",fill:r?"rgba(0, 255, 128, 0.5)":"rgba(255, 0, 0, 0.3)",stroke:r?"rgba(0, 255, 128, 1)":"rgba(255, 0, 0, 0.6)",strokeWidth:"0.1",onClick:()=>r&&L(t),style:{cursor:r?"pointer":"not-allowed"}},`selectable-${t.lane}`)}),!R&&"coin-placement"===a&&Object.values(C).flat().map(e=>(0,qt.jsx)("circle",{cx:e.x,cy:e.y,r:"0.4",fill:"rgba(255, 255, 0, 0.2)",stroke:"rgba(255, 255, 0, 0.5)",strokeWidth:"0.05",onClick:()=>L(e),style:{cursor:"pointer"}},`coin-spot-${e.lane}-${e.id}`)),i&&Object.entries(i).map(e=>{var n;let[r,i]=e;const[a,s]=r.split("-").map(Number),l=N(a,s);return(0,qt.jsxs)(Rd,{transform:`translate(${l.x}, ${l.y})`,children:[(0,qt.jsx)("title",{children:`Coin placed by ${(null===(n=t.find(e=>e.id===i.placedBy))||void 0===n?void 0:n.name)||"Unknown"}`}),(0,qt.jsx)("circle",{r:"0.5",fill:P[i.placedBy]||"#fff",opacity:"0.8"}),(0,qt.jsx)("text",{fontSize:"0.5",fill:"#000",fontWeight:"bold",textAnchor:"middle",dominantBaseline:"central",children:i.placedBy===o?i.value.charAt(0):"?"})]},r)}),n&&t.map(e=>{const t=n[e.id];if(!t)return null;let r;return r=t.inPit?z(t.position):N(t.position||96,t.lane||1),(0,qt.jsxs)(Cd,{transform:`translate(${r.x}, ${r.y})`,isRacing:t.isRacing,children:[(0,qt.jsx)("title",{children:`${e.name} - Lap ${t.lap||0}`}),(0,qt.jsx)(jd,{r:"0.7",fill:P[e.id],isCurrentPlayer:e.id===o}),(0,qt.jsx)(Td,{children:(i=e.name,i.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2))})]},e.id);var i})]})}),c&&(0,qt.jsxs)(Od,{children:[(0,qt.jsx)(Pd,{onClick:()=>handleZoom(.2),disabled:!$,children:"+"}),(0,qt.jsx)(Pd,{onClick:()=>handleZoom(-.2),disabled:!$,children:"-"}),(0,qt.jsx)(Pd,{onClick:()=>{S(!0),h(0),m(0),y(1),setTimeout(()=>S(!1),500)},disabled:!$,children:"Reset"})]}),d&&(0,qt.jsxs)(Nd,{children:[(0,qt.jsxs)("div",{className:"info",children:["Zoom: ",v.toFixed(2),"x"]}),(0,qt.jsxs)("div",{className:"info",children:["Stage: ",a]}),R&&(0,qt.jsx)("div",{className:"info",children:"Loading Track..."}),O&&(0,qt.jsx)("div",{className:"info",style:{color:"red"},children:O})]})]})},Ad=Bi`
...
`,Ui.div`
  ...
  ${Mi`animation: ${Md} 0.8s ease-out;`}
`),Bd=Ui.div`
  max-width: 1400px;
  margin: 0 auto;
  ${Mi`animation: ${Md} 0.6s ease-out;`}
`,Wd=Ui.h1`
  font-family: 'Orbitron', monospace;
  font-size: 2.5rem;
  color: #00d4ff;
  ...
  ${Mi`animation: ${Fd} 3s ease-in-out infinite;`}
`,Hd=Ui.p`
  font-family: 'Rajdhani', sans-serif;
  font-size: 1.2rem;
  color: rgba(255, 255, 255, 0.8);
...
`,Gd=Ui.div`
  ...
  animation: ${Id} 0.5s ease-out, pulse 2s infinite;
...
`;const Ff=function(e){let{message:t}=e;const{clearError:n}=Jt();return(0,r.useEffect)(()=>{const e=setTimeout(()=>{n()},5e3);return()=>clearTimeout(e)},[n]),t?(0,qt.jsxs)($f,{children:[(0,qt.jsx)(Df,{children:"\u26a0"}),(0,qt.jsx)(Mf,{children:t}),(0,qt.jsx)(If,{onClick:n,children:"\xd7"})]}):null},Uf=Bi`
...
`,qf=Ui.div`
  ...
  position: relative;
  overflow: hidden;
  ${Mi`animation: ${Hf} 3s ease-in-out infinite;`}
  ...
  &::before {
    ...
    ${Mi`animation: ${Vf} 4s ease-in-out infinite;`}
  }
`,Kf=Ui.div`
  position: relative;
  width: 80px;
...
`,Qf=Ui.div`
  ...
  border-radius: 50%;
  ${Mi`animation: ${Uf} 1.5s linear infinite;`}
`,Xf=Ui.div`
  position: absolute;
  top: 10px;
  left: 10px;
  ...
  border-radius: 50%;
  ${Mi`animation: ${Uf} 1s linear infinite reverse;`}
`,Gf=Ui.div`
  position: absolute;
  top: 20px;
  left: 20px;
  ...
  align-items: center;
  justify-content: center;
  ${Mi`animation: ${Wf} 2s ease-in-out infinite;`}
...
`,Jf=Ui.div`
  ...
  font-size: 20px;
  font-weight: 700;
  ${Mi`animation: ${Bf} 2s ease-in-out infinite;`}
  text-align: center;
  text-shadow: 
    0 0 10px #00d4ff,
...
`,tp=Ui.div`
  ...
  border-radius: 50%;
  background: #00d4ff;
  ${Mi`animation: ${Bf} 1.5s ease-in-out infinite;`}
...
`,rp=Ui.div`
  ...
  border-radius: 50%;
  ${Mi`animation: ${Uf} 1s linear infinite;`}
`;const ip=function(e){let{overlay:t=!1,text:n="Loading Havoc Speedway...",subtext:r="Preparing your racing experience",inline:i=!1}=e;if(i)return(0,qt.jsx)(np,{children:(0,qt.jsx)(rp,{})});const o=(0,qt.jsxs)(qf,{children:[(0,qt.jsxs)(Kf,{children:[(0,qt.jsx)(Qf,{}),(0,qt.jsx)(Xf,{}),(0,qt.jsx)(Gf,{})]}),(0,qt.jsxs)("div",{children:[(0,qt.jsx)(Jf,{children:n}),r&&(0,qt.jsx)(Zf,{children:r}),(0,qt.jsxs)(ep,{children:[(0,qt.jsx)(tp,{delay:0}),(0,qt.jsx)(tp,{delay:.2}),(0,qt.jsx)(tp,{delay:.4})]})]})]});return t?(0,qt.jsx)(Yf,{children:o}):o};const op=function(){const{currentView:e,loading:t,error:n,isConnected:r}=Jt();return r?(0,qt.jsxs)("div",{className:"App",children:[n&&(0,qt.jsx)(Ff,{message:n}),t&&(0,qt.jsx)(ip,{overlay:!0}),(0,qt.jsxs)(ye,{children:[(0,qt.jsx)(me,{path:"/",element:"welcome"===e?(0,qt.jsx)(io,{}):"lobby"===e?(0,qt.jsx)(zo,{}):"room"===e?(0,qt.jsx)(pa,{}):"game"===e?(0,qt.jsx)(Af,{}):(0,qt.jsx)(ge,{to:"/",replace:!0})}),(0,qt.jsx)(me,{path:"*",element:(0,qt.jsx)(ge,{to:"/",replace:!0})})]})]}):(0,qt.jsxs)("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100vh",flexDirection:"column",gap:"20px"},children:[(0,qt.jsx)(ip,{}),(0,qt.jsx)("p",{children:"Connecting to Havoc Speedway..."})]})};o.createRoot(document.getElementById("root")).render((0,qt.jsx)(r.StrictMode,{children:(0,qt.jsx)(we,{children:(0,qt.jsx)(Gt,{children:(0,qt.jsx)(op,{})})})}))})()})();
//# sourceMappingURL=main.9b2bc684.js.map